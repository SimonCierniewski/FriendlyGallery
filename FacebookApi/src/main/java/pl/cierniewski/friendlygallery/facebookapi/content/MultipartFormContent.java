...
/**
 * Serializes MIME multipart content to the form-data standard. Adapated from {@link com.google.api.client.http.MultipartContent}
 * <p/>
 * <p>
 * By default the media type is {@code "multipart/form-data; boundary=__END_OF_PART__"}, but this may
 * be customized by calling {@link #setMediaType(com.google.api.client.http.HttpMediaType)}, {@link #getMediaType()}, or
...
public class MultipartFormContent extends AbstractHttpContent
{
    ...
    {
        getMediaType().setParameter("boundary", checkNotNull(boundary));
        return this;
    }
    ...
    public static final class Part
    {
        ...
        /**
         * @param name HTTP name or {@code null} for none
